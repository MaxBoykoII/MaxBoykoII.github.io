...
export const backEndSkills = ['Node',
    'Express',
    'MongoDB',
    'Building web apps',
...
export const experienceGoldMinerPulse = [
...
export const experienceFreeCodeCamp = [
...
export const educationFreeCodeCamp = [
...
export const educationCodeSchool = [
